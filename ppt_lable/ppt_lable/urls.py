...
from myapp.views import create_folder_view, catalog_list_view, delete_catalog_view, create_subitem_view, edit_catalog_view, move_catalog_view, ppt_list_view, import_ppt_view, catalog_detail_view, delete_ppt_view, move_ppt_view, edit_ppt_view, split_ppt_view, split_progress_view
urlpatterns = [
